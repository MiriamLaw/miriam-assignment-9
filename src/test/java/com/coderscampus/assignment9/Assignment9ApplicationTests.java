...
class Assignment9ApplicationTests {
	...
	void testGetVeganRecipes() throws Exception {
		...
		Recipe veganRecipe = new Recipe(45, true, true, "1. Place the lentils, turmeric, salt and water in a large saucepan", 
		...
		Recipe nonVeganRecipe = new Recipe(135, false, false, 
				"1 Heat oven to 350F. Grease bottom and sides of 13x9-inch pan with shortening", 
				30.0, 99.92, 165, 12, 54.0, "Butterfly Stencil Cake", false, false);
	...
	void testVeganAndGlutenFreeRecipes() throws Exception {
		...
		Recipe veganAndGlutenFreeRecipe = new Recipe(40, true, true, 
				"To Make The Almond Topping:Stir all ingredients together until combined", 
				5.0, 118.77, 45, 8, 39.0, "Berry Almond Crisp", true, true);
		
		allRecipes.add(veganAndGlutenFreeRecipe);
		
		Recipe nonVeganAndGlutenFreeRecipe = new Recipe(0, false, false, "Procedures 1 Make the crust", 
				0.0, 131.78, 75, 8, 34.0, "Meyer Lemon Mascarpone Cake", false, false);
	...
	void testVegetarianRecipes() throws Exception {
		...
		Recipe vegetarianRecipe = new Recipe(45, true, true, "1. Place the lentils, turmeric, salt and water in a large saucepan", 
				15.0, 59.89, 60, 6, 63.0, "Zucchini with Lentils and Roasted Garlic", true, true);
